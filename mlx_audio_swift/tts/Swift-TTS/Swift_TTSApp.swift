...
/// neural TTS capabilities while also functioning as a testbed for TalkToMe integration.
///
...
/// - **Integration Testing**: Serves as development platform for TalkToMe MLX integration
...
///
/// Integration Context:
/// - **TalkToMe Bridge**: This app validates MLX components before TalkToMe integration
...
/// - **Integration Preview**: Preview of MLX capabilities before TalkToMe deployment
...
/// platform for validating MLX synthesis integration with the main TalkToMe application.
@main
